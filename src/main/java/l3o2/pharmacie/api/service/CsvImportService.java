...
public int importCisHasAsmr(String csvFilePath) {
    ...
    // Méthodes de parsing pour chaque type d'entité
    ...
    /**
     * Parse une chaîne de date au format yyyyMMdd.
     * 
     * @param dateStr Chaîne représentant une date au format ISO
     * @return Objet Date parsé
     * @throws ParseException Si le format de date est invalide
     */
    private Date parseIsoDate(String dateStr) throws ParseException {
        if (dateStr == null || dateStr.trim().isEmpty()) {
            return new Date();
        }
...
private LocalDate parseLocalDate(String dateStr) {
    try {
        ...
        log.warn("Date invalide: {}", dateStr);
